...
class AbnormalityDetectionDataset(BaseDataset):
    def __init__(
        self,
        tokenizer,
        processors,
        ...
        **kwargs,
        ...
        self.task_type = kwargs["task_type"]  # abn_det
    ...
    def build_prompts_and_chats(self, data, images):
        ...
        norm_bbox = [
            normalize_bbox(*bbox, width, height, self.resize_type) for bbox in boxes
        ]
