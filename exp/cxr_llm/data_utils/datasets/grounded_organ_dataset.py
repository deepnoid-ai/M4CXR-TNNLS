...
class GroundedOrganDataset(BaseDataset):
    def __init__(
        self,
        tokenizer,
        processors,
        ...
        **kwargs,
        ...
        self.task_type = kwargs["task_type"]  # grounded_o
    ...
    def build_prompts_and_chats(self, data, images):
        ...
        for det_data in data["det"]:
            ...
            qa_pair = (
                {"role": "user", "content": template[2].format(bbox=norm_bbox)},
                {
                    "role": "assistant",
                    "content": template[3].format(organ=det_name),
                },
            )
